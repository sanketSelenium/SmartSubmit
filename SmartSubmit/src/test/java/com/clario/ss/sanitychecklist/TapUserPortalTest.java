...
import com.clario.ss.pages.TapUserPortalPage;
...
public class TapUserPortalTest extends BaseTest {
	
	String testCaseName = "TapUserPortalTest";
	...
	public void doLogin(Hashtable<String, String> data) throws Exception {
		...
		TapUserPortalPage tapUserPortalPage=new TapUserPortalPage(driver,test);
		...
		//tapUserPortalPage.tapUser(randomexceldata.readSpecificData("PortalUsers", 1, 5));
